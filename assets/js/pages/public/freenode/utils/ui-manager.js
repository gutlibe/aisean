...
getMainContent(dates, currentTab, predictions, hasMore) {
  ...
  const isPro = this.page.userType === 'Pro'
  
  // Different upgrade/premium content based on user type
  const upgradeProContent = isPro ? `
    <div id="upgrade-prompt" class="upgrade-prompt">
      <div class="upgrade-card">
        <div class="upgrade-icon">
          <i class="fas fa-star"></i>
        </div>
        <h3 class="upgrade-title">Pro Member</h3>
        <p class="upgrade-description">
          Thank you for being a Pro member! Explore more premium features and exclusive predictions.
        </p>
        <button id="upgrade-button" class="upgrade-button">
          <i class="fas fa-bolt"></i> View Premium Features
        </button>
      </div>
    </div>
  ` : `
    <div id="upgrade-prompt" class="upgrade-prompt">
      <div class="upgrade-card">
        ...
        <h3 class="upgrade-title">Unlock Premium Predictions</h3>
        <p class="upgrade-description">
          Get unlimited access to premium predictions with higher accuracy rates. Upgrade to Pro for exclusive features and more winning picks!
        </p>
        <button id="upgrade-button" class="upgrade-button">
  ...
  const upgradePrompt = container.querySelector("#upgrade-prompt")

  // Always ensure the upgrade prompt is visible
